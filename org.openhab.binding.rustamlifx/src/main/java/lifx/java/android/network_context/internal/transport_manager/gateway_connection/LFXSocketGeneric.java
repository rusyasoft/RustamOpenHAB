...
import kr.dms.iot.lifx.desktop.imitating.RusHandler;
import kr.dms.iot.lifx.desktop.imitating.RusMessage;

/*rustamchange// commenting out the imports
...
public abstract class LFXSocketGeneric 
{
	...
	private byte[] ipAddress;
	private int port;
	//rustamchange// turn offprotected Handler handler;
	protected RusHandler handler;
...
//	}
    ...
    */
	private void setHandler()
    {
    	handler = new RusHandler()
    	{
    		@Override
    		public void handleMessage( RusMessage message)
    		{
    			
    			
    			int type = message.what;
    			
    			System.out.println("handleMessage is triggered at : LFXSocketGeneric type="+type + "; message = " + message.obj);
	...
	public final static byte[] getBroadcastAddress( Context context)
	{
	    ...
	    */
		//rustamchange// static broadcast address
		byte[] quads = "255.255.255.255".getBytes(Charset.forName("UTF-8"));
