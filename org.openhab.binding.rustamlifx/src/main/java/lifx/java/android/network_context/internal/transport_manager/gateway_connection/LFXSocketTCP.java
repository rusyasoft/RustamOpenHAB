...
//	}
	...
	{
		//rustamchange// turn offprivate Handler handler;
		
		public TCPReceiveTask() //rustamchange//Handler handler)
    	{
    		super();
    		//rustamchange// turn off// this.handler = handler;
    	}
	...
	public void connect( byte[] ipAddress, int port) 
	{
		...
		asyncSocket = new Thread( new TCPReceiveTask()); //rustamchange//handler));
		asyncSocket.start();
	}
